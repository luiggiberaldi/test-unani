...
const rawM1: CsvQ[] = [
  ['m1_1', 'opcion_unica', 'Proporción torso vs extremidades', 'Párate frente a un espejo relajado. ¿Tus brazos pasan más abajo de la mitad del muslo o parecen largos en relación a tu tronco?', ['Torso corto, extremidades largas (angular)', 'colerico'], ['Redondeado o suave, poca definición', 'flematico'], ['Denso, proporcionado, fuerte', 'sanguineo'], ['Alargado, fino, sin mucha curva', 'melancolico']],
  ['m1_2', 'opcion_unica', 'Sensación general del cuerpo', 'Piensa en cómo describes tu cuerpo cuando no estás haciendo nada. ¿Tienes sensación de tensión, peso, ligereza o delicadeza como punto de partida?', ['Fuerte, tenso, preparado para la acción', 'colerico'], ['Pesado, relajado, tendiendo a la retención', 'flematico'], ['Compacto, ágil, enraizado', 'sanguineo'], ['Liviano, delicado, a veces frágil', 'melancolico']],
  ['m1_3', 'opcion_unica', 'Facilidad para ganar músculo (sin esfuerzo sostenido)', 'Observa tu historial deportivo. ¿Has notado que con apenas dos semanas de estímulo tus fibras musculares ya se marcan, o tiendes a quedar igual o blando?', ['Naturalmente defino el músculo rápido', 'colerico'], ['Me cuesta mucho, tiendo a ganar peso blando', 'flematico'], ['Gano músculo muy fácilmente, soy de contextura ancha', 'sanguineo'], ['Me cuesta mucho, siempre he sido de contextura delgada', 'melancolico']],
  ['m1_4', 'opcion_unica', 'Facilidad para retener líquidos', 'Mírate los tobillos o las marcas de las medias al final del día. ¿Se queda hundida la piel con facilidad, o se siente firme y seca sin marcas?', ['Casi nunca, mi piel es firme y seca', 'colerico'], ['Constantemente, me siento hinchado/a con facilidad', 'flematico'], ['A veces, sobre todo si hace mucho calor', 'sanguineo'], ['Pocas veces, mi problema es la sequedad', 'melancolico']],
  ['m1_5', 'opcion_unica', 'Dónde acumulas grasa primero', 'Cuando subes un par de kilos, ¿en qué zona se nota inmediatamente? ¿Se distribuye de forma homogénea en la panza o va directo a las caderas y muslos?', ['En todo el cuerpo por igual o grasa visceral', 'colerico'], ['Bajo la piel, caderas, glúteos, muslos', 'flematico'], ['En el abdomen superior y pecho', 'sanguineo'], ['Casi no acumulo o lo hago solo en el bajo abdomen', 'melancolico']],
  ['m1_6', 'opcion_unica', 'Tamaño de las manos', 'Extiende tu mano dominante frente a ti. ¿Es ancha y cálida, pequeña con dedos carnosos, o larga y estilizada con tendencia a enfriarse?', ['Medianamente grandes, dedos angulares', 'colerico'], ['Pequeñas, dedos redondeados o carnosos', 'flematico'], ['Grandes, cálidas, palmas anchas', 'sanguineo'], ['Largas, dedos muy finos, frías', 'melancolico']],
  ['m1_7', 'opcion_unica', 'Percepción de densidad ósea', 'Rodea tu muñeca contraria con tus dedos pulgar e índice. ¿Se superponen con facilidad, apenas se tocan, o queda un espacio grande porque tu esqueleto es ancho?', ['Huesos medianos pero fuertes', 'colerico'], ['Huesos pequeños o no se notan bajo la piel', 'flematico'], ['Esqueleto ancho y pesado', 'sanguineo'], ['Esqueleto muy liviano, nudillos prominentes', 'melancolico']],
  ['m1_8', 'opcion_unica', 'Forma natural del rostro', 'Tómate una foto de frente y una de costado con luz natural. ¿Qué figura geométrica describe mejor la silueta de tu cara: triángulo invertido, óvalo alargado, cuadrado, o círculo?', ['Triangular o con mandíbula muy marcada', 'colerico'], ['Redondeado, cachetes suaves', 'flematico'], ['Cuadrado, base sólida', 'sanguineo'], ['Alargado, hundido, frente alta', 'melancolico']],
  ['m1_9', 'opcion_unica', 'Estructura mandibular', 'Pasa tus dedos por el borde inferior de tu mandíbula de la oreja a la barbilla. ¿Es un ángulo recto muy marcado y duro, o es un contorno suave y redondeado?', ['Muy afilada y marcada', 'colerico'], ['Suave e imperceptible', 'flematico'], ['Fuerte y ancha', 'sanguineo'], ['Delicada y fina', 'melancolico']],
  ['m1_10', 'opcion_unica', 'Tipo de mirada/ojos', 'Pregunta a tus seres queridos cercanos cómo perciben tu mirada cuando estás distraído. ¿Suelen decir que intimida, que transmite dulzura, o que parece melancólica y profunda?', ['Intensa, directa, penetrante', 'colerico'], ['Grandes, húmedos, tiernos', 'flematico'], ['Vivaces, móviles, magnéticos', 'sanguineo'], ['Profundos, serios, como si miraran más allá', 'melancolico']],
  ['m1_11', 'opcion_unica', 'Textura de piel', 'Toca tu antebrazo con el dorso de la otra mano. ¿Sueles sentir la piel áspera y caliente, suave pero húmeda, o extremadamente fina y propensa a descamarse?', ['Seca y muy caliente', 'colerico'], ['Húmeda and fría', 'flematico'], ['Húmeda y caliente', 'sanguineo'], ['Seca, fina y fría', 'melancolico']],
  ['m1_12', 'opcion_unica', 'Temperatura corporal percibida habitualmente', 'Observa tu comodidad en ambientes promedio. ¿Eres de los que siempre pide ventilación, o necesitas un suéter liviano incluso cuando otros están cómodos en remera?', ['Siempre tengo calor', 'colerico'], ['Casi siempre tengo frío interior', 'flematico'], ['Soy caluroso pero sudo para regularme', 'sanguineo'], ['Tengo los pies y manos fríos constantemente', 'melancolico']],
  ['m1_13', 'opcion_unica', 'Tendencia a sudar', 'Piensa en una charla intensa o una caminata breve. ¿Tu cuerpo rompe a sudar para disipar calor con facilidad, o te mantienes seco sin importar la actividad?', ['Poco, siento el calor pero no sudo tanto', 'colerico'], ['Casi nada', 'flematico'], ['Mucho, sobre todo al moverme o interactuar', 'sanguineo'], ['Poco, solo un sudor frío si me estreso', 'melancolico']],
  ['m1_14', 'opcion_unica', 'Cantidad de vello corporal', 'Mira tus brazos y piernas detalladamente. ¿Tienes vello abundante, oscuro y fuerte en la mayor parte del cuerpo, o es muy fino y escaso?', ['Mucho, tiende a ser grueso', 'colerico'], ['Poco, fino y claro', 'flematico'], ['Abundante y oscuro', 'sanguineo'], ['Moderado a poco, irregular', 'melancolico']],
  ['m1_15', 'opcion_unica', 'Cambios en tu cuerpo bajo estrés sostenido', 'Recuerda tu última semana de alta tensión en el trabajo. ¿Sentiste que tu cuerpo se contraía perdiendo peso y apetito, o que se inflaba reteniendo agua?', ['Me tenso mucho pero mi peso se mantiene o baja un poco', 'colerico'], ['Tiendo a retener líquidos o ganar peso, me hincho', 'flematico'], ['Depende, pero suelo comer más', 'sanguineo'], ['Pierdo peso rápidamente, pierdo el apetito', 'melancolico']],
  ['m1_16', 'opcion_unica', 'Tu complexión en la pubertad / adolescencia temprana', 'Busca fotos tuyas de cuando tenías entre 12 y 15 años. ¿Tenías un aspecto atlético y definido sin entrenar, o eras más bien espigado, alto y de aspecto frágil?', ['Atlética sin hacer esfuerzo', 'colerico'], ['Rellenita o tendiente a ganar peso', 'flematico'], ['Fuerte, desarrollada rápido', 'sanguineo'], ['Elegante o muy delgada, estirada', 'melancolico']],
  ['m1_17', 'comparativa', '¿En reposo tu cuerpo se calienta o se enfría?', 'Recuéstate 10 minutos sin moverte a temperatura templada. ¿Sientes que tu cuerpo empieza a irradiar un calor denso de estufa, o tus extremos se vuelven fríos?', ['Guarda mucho calor', 'colerico'], ['Se enfría y necesito abrigo', 'flematico'], ['Se relaja y suda', 'sanguineo'], ['Se vuelve rígido y frío', 'melancolico']],
  ['m1_18', 'comparativa', 'Reacción rápida', 'Cuando te sobresalta un ruido fuerte, ¿en qué parte acumulas la respuesta refleja inmediata? ¿Se traba tu mandíbula, suspendes la respiración o se te eriza la piel?', ['Mucha tensión muscular en la mandíbula o cuello', 'colerico'], ['Bajo nivel de energía en el cuerpo', 'flematico'], ['Gesticulación amplia con los brazos', 'sanguineo'], ['Tensión en la base del cráneo y ojos secos', 'melancolico']],
];

const rawM2: CsvQ[] = [
  ['m2_1', 'opcion_unica', 'Tolerancia al calor intenso', 'Visualízate al sol en pleno verano a mediodía. ¿Sientes que el calor te da un impulso de enojo e impaciencia, o te aplasta la energía y te obliga a dormir?', ['Lo aguanto bien pero a veces me enoja', 'colerico'], ['Lo sufro mucho, me agota', 'flematico'], ['No me molesta tanto, sudo y me muevo', 'sanguineo'], ['Me seca la piel y me frustra, prefiero el clima fresco', 'melancolico']],
  ['m2_2', 'opcion_unica', 'Tolerancia al frío', 'Piensa en un día de invierno muy nublado. ¿Sientes que el frío es una molestia superficial que dominas moviéndote, o te duele profundamente en las articulaciones?', ['No me afecta casi nada, ando en remera en invierno', 'colerico'], ['Me resulta terrible, necesito estar muy abrigado/a', 'flematico'], ['Lo tolero si estoy activo, pero me gusta más el calor', 'sanguineo'], ['El frío me duele en los huesos y articulaciones', 'melancolico']],
  ['m2_3', 'opcion_unica', 'Reacción al aire acondicionado continuo', 'Recuerda la última vez que estuviste en una oficina con AC fuerte todo el día. ¿Cómo quedó tu cuerpo al final: bien, indiferente, contracturado, o con la garganta seca?', ['Lo disfruto', 'colerico'], ['Me hace sentir mal o me resfrío fácil', 'flematico'], ['Me da igual si estoy entretenido/a', 'sanguineo'], ['Siento que me seca las vías respiratorias y articulaciones', 'melancolico']],
  ['m2_4', 'opcion_unica', 'Necesidad de abrigo', 'Compara tu ropa con la de tus acompañantes en una noche fresca. ¿Llevas siempre la menor cantidad de abrigo o necesitas cubrir pies, manos y cuello de forma obsesiva?', ['Siempre tengo menos ropa que el resto', 'colerico'], ['Siempre soy el primero en taparme', 'flematico'], ['Promedio, aunque varío mucho', 'sanguineo'], ['Always tengo frío en manos y pies, uso varias capas', 'melancolico']],
  ['m2_5', 'opcion_unica', 'Energía en clima húmedo', 'Observa tu rendimiento en un día lluvioso y pesado de verano. ¿Sientes tu cuerpo como si pesara el doble de lo normal, impidiéndote pensar con rapidez?', ['Me da más calor y rabia', 'colerico'], ['Me siento aplastado, pesado', 'flematico'], ['Sudo muchísimo pero funciono', 'sanguineo'], ['Odio la humedad, siento que no puedo respirar', 'melancolico']],
  ['m2_6', 'opcion_unica', 'Sensibilidad digestiva regular', 'Presta atención a cómo responde tu estómago tras comer algo pesado bajo nerviosismo. ¿Tiendes a la gastritis por exceso de fuego digestivo o sufres hinchazón y gases?', ['A veces acidez o gastritis al estresarme', 'colerico'], ['Digestión muy lenta, pesadez habitual', 'flematico'], ['Digiero cualquier cosa sin problema', 'sanguineo'], ['Intestino muy sensible (irritable), gases o dolor con el estrés', 'melancolico']],
  ['m2_7', 'opcion_unica', 'Patrón de sueño', 'Analiza tu despertar habitual. ¿Saltas de la cama listo y enfocado tras pocas horas, o necesitas al menos una hora y varios cafés para sentir que tu mente despertó?', ['Duermo poco pero me levanto como nuevo', 'colerico'], ['Duermo muchas horas, me cuesta arrancar', 'flematico'], ['Duermo irregular y me acuesto tarde', 'sanguineo'], ['Me cuesta conciliar el sueño o me despierto pensando', 'melancolico']],
  ['m2_8', 'opcion_unica', 'Tendencia a contracturas', 'Toca tus hombros y la base del cuello ahora mismo. ¿Se sienten blandos y elásticos, o hay nudos tensionales recurrentes y rígidos como cemento?', ['Sí, hombros y cuello fijos como piedra', 'colerico'], ['Poco, suelo estar bastante flojo', 'flematico'], ['A veces en la espalda baja u hombros', 'sanguineo'], ['Sí, dolores erráticos y tensionales en varios lados', 'melancolico']],
  ['m2_9', 'opcion_unica', 'Somatización del estrés principal', 'Cuando pasas por una mala racha, ¿cuál es el primer órgano que grita? ¿Es la cabeza con dolor punzante, el estómago pesado, o el colon que se inflama?', ['Cabeza (migrañas)', 'colerico'], ['Estómago (pesadez)', 'flematico'], ['Pecho o palpitaciones', 'sanguineo'], ['Intestino o dolores nerviosos continuos', 'melancolico']],
  ['m2_10', 'opcion_unica', 'Pico de energía en el día', 'Si pudieras elegir tu horario más productivo sin obligaciones, ¿cuándo rinde mejor tu mente: a primera hora del alba o en el silencio absoluto de la medianoche?', ['En cuanto amanece, salto de la cama', 'colerico'], ['Nunca tengo un pico real, voy lento', 'flematico'], ['Por la tarde/noche, me enciendo si hay gente', 'sanguineo'], ['En la madrugada, cuando todos duermen', 'melancolico']],
  ['m2_11', 'opcion_unica', 'Reacción ante ruidos fuertes repentinos', 'Presta atención a tu entorno cuando estás concentrado. ¿Te saca de quicio un golpeteo repetitivo o una bocina, generándote irritación nerviosa inmediata?', ['Me enojan o me ponen a la defensiva', 'colerico'], ['Me asustan y trato de evitarlos', 'flematico'], ['Los noto y reacciono de manera curiosa o habladora', 'sanguineo'], ['Me alteran muchísimo los nervios y me agotan el foco', 'melancolico']],
  ['m2_12', 'opcion_unica', 'Sensibilidad al dolor físico', 'Recuerda la última vez que te golpeaste un dedo o te raspaste. ¿Sigues adelante casi sin registrar el dolor, o te paraliza la mente analizándolo?', ['Tolerancia alta, sigo adelante aunque me duela', 'colerico'], ['Lo sufro en silencio y lloro a solas', 'flematico'], ['Me quejo en voz alta, pero se me pasa pronto', 'sanguineo'], ['Lo analizo demasiado y aumenta mi ansiedad', 'melancolico']],
];
...
export function getFilteredQuestions(isDeepMode: boolean): Question[] {
  ...
  moduleOrder.forEach(moduleId => {
    ...
    const step = qs.length / targetCount;
    const selectedSet = new Set<string>();

    for (let i = 0; i < targetCount; i++) {
      const index = Math.min(Math.floor(i * step), qs.length - 1);
      const q = qs[index];
    ...
    // Si no se llenó el cupo por colisiones, rellena con los que falten
    if (selected.filter(q => q.moduleId === moduleId).length < Math.min(targetCount, qs.length)) {
      qs.forEach(q => {
        if (!selectedSet.has(q.id) && selected.filter(x => x.moduleId === moduleId).length < Math.min(targetCount, qs.length)) {
          selectedSet.add(q.id);
          selected.push(q);
        }
      });
